...
//		lista.sort(comparator);
		...
		//ordem natural, utilizando o compare to dentro da classe conta
...
class TitularDaContaComparator implements Comparator<Conta> {
	...
	public int compare(Conta c1, Conta c2) {
		...
		//Se a primeira string for menor que a segunda, o resultado é negativo
		//Se a primeira for maior que a segunda, o resultado é positivo
